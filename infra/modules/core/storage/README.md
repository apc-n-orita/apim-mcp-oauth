...
| <a name="input_is_hns_enabled"></a> [is\_hns\_enabled](#input\_is\_hns\_enabled) | Whether to enable hierarchical namespace. Required for Data Lake Storage Gen2. Once enabled, it cannot be disabled. | `bool` | `false` | no |
